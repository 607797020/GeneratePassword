pipeline {
  ...
  stages {
	...
	stage('Deployment') {
      steps {
        sh 'java -cp /home/jenkins/wls/wlfullclient.jar weblogic.Deployer -debug -remote -verbose -noexit -name GeneratePassword -targets managed2_dnpwls01 -adminurl t3://172.17.0.2:61000 -userconfigfile /home/jenkins/wls/configuration.xml -user weblogic -undeploy'
